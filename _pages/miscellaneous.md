...
-	I am an enthusiastic coder. I use Fortran, Java, C(C++, C#), Python, Ruby, Julia, JavaScript, R, Stata, Bash, SPSS, SmartPLS, SQL... But it would also be great if AI could handle some of my routine coding tasks in the future lol.
